...
help:
	@echo "Thanks for your interest in Dff Alice Connector!"
	@echo
...
format: venv
	@$(VENV_PATH)/bin/python -m black --exclude="setup\.py" --exclude="virtualenv" --line-length=120 .
.PHONY: format
...
build_doc: venv
	...
	sphinx-apidoc -e -f -o docs/source/apiref dff_alice_connector
